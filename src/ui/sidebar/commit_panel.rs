...
pub(in crate::ui) struct CommitPanel {
    pub(in crate::ui) root: gtk::Box,
    pub(in crate::ui) avatar: adw::Avatar,
    pub(in crate::ui) avatar_button: gtk::Button,
    pub(in crate::ui) remote_owner_warning: gtk::Image,
    pub(in crate::ui) summary_entry: gtk::Entry,
    pub(in crate::ui) description_view: gtk::TextView,
    pub(in crate::ui) generate_button: gtk::Button,
    pub(in crate::ui) generate_icon_stack: gtk::Stack,
    pub(in crate::ui) commit_button: gtk::Button,
...
impl CommitPanel {
    ...
    pub(in crate::ui) fn set_branch(&self, branch: &str) {
    ...
    pub(in crate::ui) fn update_avatar(&self, snapshot: &RepositorySnapshot) {
        let text = snapshot
            .user_name
            .as_deref()
