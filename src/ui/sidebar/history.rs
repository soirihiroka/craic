...
#[derive(Clone)]
pub(in crate::ui) struct HistoryList {
...
impl HistoryList {
    ...
    pub(in crate::ui) fn connect_context_requested<F>(&self, callback: F)
    where
    ...
    pub(in crate::ui) fn ensure_loaded(&self) {
    ...
    pub(in crate::ui) fn load_next_page(&self, select_first: bool) {
    ...
    pub(in crate::ui) fn selected_commit_hash(&self) -> Option<String> {
        self.selection
            .selected_item()
    ...
    pub(in crate::ui) fn select_first_commit(&self) {
...
glib::wrapper! {
    pub(in crate::ui) struct CommitItem(ObjectSubclass<commit_item::CommitItem>);
}
...
mod commit_item {
    ...
    #[derive(Default)]
    pub(in crate::ui) struct CommitItem {
        pub(in crate::ui) hash: RefCell<String>,
        pub(in crate::ui) short_hash: RefCell<String>,
        pub(in crate::ui) subject: RefCell<String>,
        pub(in crate::ui) author: RefCell<String>,
        pub(in crate::ui) author_email: RefCell<Option<String>>,
        pub(in crate::ui) relative_time: RefCell<String>,
        pub(in crate::ui) insertions: Cell<usize>,
        pub(in crate::ui) deletions: Cell<usize>,
        pub(in crate::ui) tags: RefCell<Vec<String>>,
    }
