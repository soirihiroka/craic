...
pub(super) struct ChangesRight {
    ...
    title: gtk::Label,
    subtitle: gtk::Label,
    pub(super) initialize_button: gtk::Button,
...
impl ChangesRight {
    ...
    pub(super) fn update(&self, snapshot: &RepositorySnapshot, action_running: bool) {
    ...
    pub(super) fn show_initialize_repository(&self) {
