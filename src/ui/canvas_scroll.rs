...
impl MarkerColor {
    pub(crate) const fn rgba(red: f64, green: f64, blue: f64, alpha: f64) -> Self {
        Self {
            red,
            green,
            blue,
...
#[derive(Clone, Copy, Debug)]
pub(crate) struct MarkerStyle {
    pub(crate) foreground: MarkerColor,
    pub(crate) background: MarkerColor,
    pub(crate) shadow: MarkerColor,
}
...
impl MiddleAutoscroll {
    ...
    pub(crate) fn state(&self) -> Option<MiddleAutoscrollState> {
        self.state.get()
    }

    pub(crate) fn start(&self, x: f64, y: f64) -> MiddleAutoscrollState {
    ...
    pub(crate) fn update_pointer(&self, x: f64, y: f64) -> Option<MiddleAutoscrollState> {
    ...
    pub(crate) fn set_source(&self, source: gtk::glib::SourceId) {
...
pub(crate) fn middle_autoscroll_frame_duration() -> Duration {
    Duration::from_millis(MIDDLE_AUTOSCROLL_FRAME_MS)
}

pub(crate) fn middle_autoscroll_delta(offset: f64) -> f64 {
...
pub(crate) fn middle_autoscroll_cursor(
...
pub(crate) fn install_middle_autoscroll<
    W,
    CanScroll,
    ApplyScroll,
    PrepareStart,
...
pub(crate) fn install_scrolled_window_middle_autoscroll(
...
pub(crate) fn install_scrolled_window_middle_autoscroll_with_state<SetCursor>(
    scroller: &gtk::ScrolledWindow,
    marker: &gtk::DrawingArea,
    autoscroll: &Rc<MiddleAutoscroll>,
    axes: AutoscrollAxes,
...
pub(crate) fn install_middle_autoscroll_marker(
    marker: &gtk::DrawingArea,
    autoscroll: &Rc<MiddleAutoscroll>,
    axes: AutoscrollAxes,
) {
...
pub(crate) fn middle_autoscroll_edge_pointer(
...
pub(crate) fn middle_autoscroll_surface_pointer(widget: &impl IsA<gtk::Widget>) -> Option<Point> {
...
pub(crate) fn draw_middle_autoscroll_marker(
