...
pub(crate) struct TabbedPickerItem {
    pub(crate) id: String,
...
#[derive(Clone, Debug, PartialEq, Eq)]
pub(crate) struct TabbedPickerGroup {
    pub(crate) title: Option<String>,
    pub(crate) items: Vec<TabbedPickerItem>,
}

impl TabbedPickerGroup {
    pub(crate) fn new(title: impl Into<String>, items: Vec<TabbedPickerItem>) -> Self {
        Self {
    ...
    pub(crate) fn unlabelled(items: Vec<TabbedPickerItem>) -> Self {
        Self { title: None, items }
    }
}

#[derive(Clone, Debug, PartialEq, Eq)]
pub(crate) enum TabbedPickerStatus {
    Ready,
    Loading(String),
    Empty(String),
    Error(String),
...
#[derive(Clone, Debug, PartialEq, Eq)]
pub(crate) struct TabbedPickerTab {
    pub(crate) id: String,
    pub(crate) title: String,
    pub(crate) badge: Option<usize>,
    pub(crate) groups: Vec<TabbedPickerGroup>,
    pub(crate) status: TabbedPickerStatus,
}
...
impl TabbedPickerTab {
    ...
    pub(crate) fn badge(mut self, badge: Option<usize>) -> Self {
        self.badge = badge;
        self
    }

    pub(crate) fn status(mut self, status: TabbedPickerStatus) -> Self {
        self.status = status;
        self
    }
}
...
#[derive(Clone)]
pub(crate) struct TabbedPicker {
    pub(crate) button: gtk::MenuButton,
    pub(crate) action_button: gtk::Button,
    popover: gtk::Popover,
    stack: gtk::Stack,
...
impl TabbedPicker {
    ...
    pub(crate) fn set_button_label(&self, label: &str) {
        self.button_label.set_label(label);
    }

    pub(crate) fn set_tab(&self, tab: TabbedPickerTab) {
    ...
    pub(crate) fn connect_item_activated<F: Fn(String) + 'static>(&self, callback: F) {
    ...
    pub(crate) fn connect_action_clicked<F: Fn() + 'static>(&self, callback: F) {
    ...
    pub(crate) fn connect_opened<F: Fn() + 'static>(&self, callback: F) {
