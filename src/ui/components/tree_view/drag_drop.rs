...
#[derive(Clone)]
pub(in crate::ui) struct FileDropTarget {
...
impl FileDropTarget {
    pub(in crate::ui) fn builder(mime_types: &'static [&'static str]) -> FileDropTargetBuilder {
    ...
    pub(in crate::ui) fn install<W>(&self, widget: &W)
    where
        W: IsA<gtk::Widget>,
    {
...
pub(in crate::ui) struct FileDropTargetBuilder {
    mime_types: &'static [&'static str],
    actions: gdk::DragAction,
    on_file_hover: Option<FileHoverCallback>,
    on_file_drop: Option<FileDropCallback>,
...
impl FileDropTargetBuilder {
    pub(in crate::ui) fn on_file_hover<F>(mut self, callback: F) -> Self
    where
    ...
    pub(in crate::ui) fn on_file_drop<F>(mut self, callback: F) -> Self
    where
    ...
    pub(in crate::ui) fn on_async_hover<F>(mut self, callback: F) -> Self
    where
    ...
    pub(in crate::ui) fn on_async_drop<F>(mut self, callback: F) -> Self
    where
    ...
    pub(in crate::ui) fn on_leave<F>(mut self, callback: F) -> Self
    where
        F: Fn() + 'static,
    {
    ...
    pub(in crate::ui) fn build(self) -> FileDropTarget {
        FileDropTarget {
...
#[derive(Clone)]
pub(in crate::ui) struct DragSource {
    actions: gdk::DragAction,
...
impl DragSource {
    pub(in crate::ui) fn builder() -> DragSourceBuilder {
        DragSourceBuilder {
            actions: gdk::DragAction::COPY | gdk::DragAction::MOVE,
            prepare: None,
            on_begin: None,
...
pub(in crate::ui) struct DragSourceBuilder {
    actions: gdk::DragAction,
    prepare: Option<DragPrepareCallback>,
    on_begin: Option<VoidCallback>,
    on_cancel: Option<Rc<dyn Fn() -> bool>>,
...
impl DragSourceBuilder {
    pub(in crate::ui) fn prepare<F>(mut self, callback: F) -> Self
    where
    ...
    pub(in crate::ui) fn on_begin<F>(mut self, callback: F) -> Self
    where
        F: Fn() + 'static,
    {
    ...
    pub(in crate::ui) fn on_cancel<F>(mut self, callback: F) -> Self
    where
        F: Fn() -> bool + 'static,
    {
    ...
    pub(in crate::ui) fn on_end<F>(mut self, callback: F) -> Self
    where
        F: Fn() + 'static,
    {
    ...
    pub(in crate::ui) fn build(self) -> DragSource {
        DragSource {
            actions: self.actions,
