...
pub(crate) struct ChangeListenerSubscription {
...
pub(crate) struct BackgroundPullSubscription {
    stop_sender: Option<mpsc::Sender<()>>,
    _thread: Option<thread::JoinHandle<()>>,
}
...
impl GitRepoHandle {
    ...
    pub(crate) fn schedule_background_pull_loop(
        &self,
        listener: Option<ChangeListener>,
    ...
    pub(crate) fn initialize_repository(&self, callback: OperationCallback<String>) {
        let handle = self.clone();
    ...
    pub(crate) fn commit_message_context(
        &self,
        files: &[String],
    ...
    pub(crate) fn discard_path(&self, file_path: &str, callback: OperationCallback<String>) {
        let handle = self.clone();
    ...
    pub(crate) fn check_ignored_paths(
        &self,
    ...
    pub(crate) fn settings(&self, callback: OperationCallback<GitSettings>) {
        let handle = self.clone();
    ...
    pub(crate) fn save_settings(&self, settings: &GitSettings, callback: OperationCallback<()>) {
        let handle = self.clone();
    ...
    pub(crate) fn push(&self, callback: OperationCallback<String>) {
        let handle = self.clone();
        run_operation("git push", callback, move || handle.push_blocking());
    }

    pub(crate) fn pull(&self, callback: OperationCallback<String>) {
        let handle = self.clone();
        run_operation("git pull", callback, move || handle.pull_blocking());
    }

    pub(crate) fn publish(&self, remote: &str, branch: &str, callback: OperationCallback<String>) {
        let handle = self.clone();
    ...
    pub(crate) fn checkout_branch(&self, branch: &str, callback: OperationCallback<String>) {
        let handle = self.clone();
        let branch = branch.to_string();
    ...
    pub(crate) fn checkout_pull_request(&self, number: u32, callback: OperationCallback<String>) {
        let handle = self.clone();
    ...
    pub(crate) fn create_branch(&self, branch: &str, callback: OperationCallback<String>) {
        let handle = self.clone();
        let branch = branch.to_string();
    ...
    pub(crate) fn checkout_commit(&self, hash: &str, callback: OperationCallback<String>) {
        let handle = self.clone();
    ...
    pub(crate) fn create_tag(&self, tag: &str, hash: &str, callback: OperationCallback<String>) {
        let handle = self.clone();
    ...
    pub(crate) fn revert_commit(&self, hash: &str, callback: OperationCallback<String>) {
        let handle = self.clone();
        let hash = hash.to_string();
    ...
    pub(crate) fn cherry_pick_commit(&self, hash: &str, callback: OperationCallback<String>) {
        let handle = self.clone();
        let hash = hash.to_string();
    ...
    pub(crate) fn stash_changes(&self, callback: OperationCallback<String>) {
        let handle = self.clone();
    ...
    pub(crate) fn pop_stash(&self, callback: OperationCallback<String>) {
        let handle = self.clone();
    ...
    pub(crate) fn commit_search_page(
        &self,
        query: &str,
        after: Option<&str>,
        limit: usize,
    ...
    pub(crate) fn commit_details(&self, hash: &str, callback: OperationCallback<git::Commit>) {
        let handle = self.clone();
        let hash = hash.to_string();
    ...
    pub(crate) fn commit_message(
        &self,
        hash: &str,
        callback: OperationCallback<git::CommitMessage>,
    ) {
        let handle = self.clone();
        let hash = hash.to_string();
    ...
    pub(crate) fn commit_parent_hash(
        &self,
        hash: &str,
        callback: OperationCallback<Option<String>>,
    ) {
        let handle = self.clone();
        let hash = hash.to_string();
    ...
    pub(crate) fn commit_changed_files(
        &self,
        hash: &str,
    ...
    pub(crate) fn commit_bytes_comparison(
        &self,
        hash: &str,
        file_path: &str,
