...
pub const SEARCH_PANEL_CSS: &str = r#"
box.search-panel {
...
impl SearchPanel {
    ...
    pub fn set_key_capture_widget<W: IsA<gtk::Widget>>(&self, widget: &W) {
        self.search_bar.set_key_capture_widget(Some(widget));
    }

    pub fn install_shortcuts<W: IsA<gtk::Widget>>(&self, widget: &W) {
    ...
    pub fn set_clear_on_close(&self, clear: bool) {
        self.clear_on_close.set(clear);
    }

    pub fn set_options_visible(&self, visible: bool) {
    ...
    pub fn set_query(&self, query: &str, select: bool) {
    ...
    pub fn connect_query_changed<F>(&self, callback: F)
    where
        F: Fn(String) + 'static,
    {
    ...
    pub fn connect_opened<F>(&self, callback: F)
    where
        F: Fn() + 'static,
    {
    ...
    pub fn connect_option_toggled<F>(&self, option: SearchOption, callback: F)
    where
        F: Fn(bool) + 'static,
    {
        match option {
    ...
    pub fn connect_tag_toggled<F>(&self, callback: F)
    where
    ...
    pub fn connect_previous<F>(&self, callback: F)
    where
        F: Fn() + 'static,
    {
    ...
    pub fn connect_next<F>(&self, callback: F)
    where
        F: Fn() + 'static,
    {
