...
pub const ICON_ROW_HEIGHT: i32 = 34;
pub const ICON_ROW_HEIGHT_F64: f64 = ICON_ROW_HEIGHT as f64;
pub const ICON_SIZE: i32 = 16;

pub const INDENT_START: i32 = 8;
pub const INDENT_STEP: i32 = 16;
pub const ROW_END_PADDING: i32 = 8;

pub const ROOT_CLASS: &str = "repo-browser-row";
pub const TREE_ROW_CLASS: &str = "repo-browser-tree-row";
pub const BUTTON_CLASS: &str = "repo-browser-row-button";
pub const STICKY_CLASS: &str = "repo-browser-sticky-row";
pub const BOTTOM_STICKY_CLASS: &str = "repo-browser-sticky-bottom";
pub const DROP_TARGET_CLASS: &str = "repo-browser-drop-target";
pub const DIMMED_CLASS: &str = "repo-browser-ignored-content";
pub const DISCLOSURE_CLASS: &str = "repo-browser-disclosure";
pub const CONTENT_CLASS: &str = "craic-tree-icon-row-content";
pub const INDENT_CLASS: &str = "craic-tree-icon-row-indent";
pub const ICON_CLASS: &str = "craic-tree-icon-row-icon";
pub const TITLE_CLASS: &str = "craic-tree-icon-row-title";
pub const ENTRY_CLASS: &str = "craic-tree-icon-row-entry";
const PROGRESS_CLASS: &str = "craic-tree-icon-row-progress";
const PROGRESS_HOVER_CLASS: &str = "craic-tree-icon-row-progress-hover";

pub type IconRowProgressCallback = Rc<dyn Fn()>;
...
impl IconRow {
    pub fn builder(title: impl Into<String>) -> IconRowBuilder {
        IconRowBuilder {
            title: title.into(),
            depth: 0,
...
impl IconRowBuilder {
    pub fn set_icon<W>(mut self, icon: W) -> Self
    where
        W: IsA<gtk::Widget>,
    {
    ...
    pub fn bottom_sticky(mut self, bottom_sticky: bool) -> Self {
        self.bottom_sticky = bottom_sticky;
        self
    }

    pub fn disclosure<W>(mut self, disclosure: W) -> Self
    where
        W: IsA<gtk::Widget>,
    {
    ...
    pub fn end_padding(mut self, end_padding: i32) -> Self {
    ...
    pub fn on_edit_activate<F>(mut self, callback: F) -> Self
    where
        F: Fn(String) + 'static,
    {
        self.edit
    ...
    pub fn on_edit_escape<F>(mut self, callback: F) -> Self
    where
        F: Fn() + 'static,
    {
    ...
    pub fn on_edit_focus_leave<F>(mut self, callback: F) -> Self
    where
        F: Fn() + 'static,
    {
        self.edit
    ...
    pub fn on_edit_changed<F>(mut self, callback: F) -> Self
    where
    ...
    pub fn progress<F>(mut self, progress: IconRowProgress, on_activate: F) -> Self
    where
        F: Fn() + 'static,
    {
    ...
    pub fn on_primary_click<F>(mut self, callback: F) -> Self
    where
    ...
    pub fn on_secondary_click<F>(mut self, callback: F) -> Self
    where
        F: Fn(&gtk::Button, &gtk::GestureClick, f64, f64) + 'static,
    {
    ...
    pub fn drag_source(mut self, drag_source: DragSource) -> Self {
        self.drag_source = Some(drag_source);
        self
    }

    pub fn trailing<W>(mut self, trailing: W) -> Self
    where
        W: IsA<gtk::Widget>,
    {
...
pub fn indent_widget(depth: usize) -> gtk::Box {
...
pub fn indent_width(depth: usize) -> i32 {
    INDENT_START + depth as i32 * INDENT_STEP
}

pub fn sync_icon_row_depth(widget: &gtk::Widget, depth: usize) -> bool {
...
pub fn sync_icon_row_selected(widget: &gtk::Widget, selected: bool) -> bool {
...
pub fn sync_icon_row_bottom_sticky(widget: &impl IsA<gtk::Widget>, bottom: bool) {
...
pub fn sync_icon_row_drop_target(widget: &impl IsA<gtk::Widget>, drop_target: bool) {
...
pub fn sync_dimmed(widget: &impl IsA<gtk::Widget>, dimmed: bool) -> bool {
