...
pub fn changed_file_row(path: &str, status: &str, active: bool) -> gtk::ListBoxRow {
...
pub fn update_changed_file_row_status(row: &gtk::ListBoxRow, status: &str) {
...
pub fn history_file_content(path: &str, status: &str) -> gtk::Box {
