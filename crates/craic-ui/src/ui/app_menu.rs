    ...
    about.connect_activate(move |_, _| {
        if let Some(app_window) = active_app_window(&app_clone) {
            let about_dialog = adw::AboutDialog::builder()
                ...
                .developer_name("Craic developers")
                .developers(vec!["Craic developers"])
                .version("0.1.0")
                .comments("A sleek GNOME Vibe IDE & Agentic Development Environment")
                .website("https://github.com/craic/Craic")
                .issue_url("https://github.com/craic/Craic/issues")
                .copyright("© 2026 Craic developers")
