...
pub struct BinaryPreviewWidgets {
    pub root: gtk::Box,
    title: gtk::Label,
...
impl BinaryPreviewWidgets {
    ...
    pub fn set_font_single(&self, file_path: &str, bytes: &[u8]) {
    ...
    pub fn set_pdf_single(&self, file_path: &str, bytes: &[u8]) {
        self.title.set_visible(false);
        self.message.set_visible(false);
        self.before.root.set_visible(true);
        self.after.root.set_visible(false);
...
pub fn set_unavailable_preview(preview: &BinaryPreviewWidgets, file_path: &str, message: &str) {
