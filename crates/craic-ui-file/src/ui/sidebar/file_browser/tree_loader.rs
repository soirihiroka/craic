...
impl FileBrowser {
    ...
    pub fn invalidate_tree_rows_cache(&self) {
    ...
    pub fn invalidate_tree_directory_cache_for_changed_files(
        &self,
...
pub fn sort_browser_rows(children: &mut [BrowserRow]) {
...
#[derive(PartialEq, Eq)]
pub struct TreeRowsCacheSignature {
    workspace_id: String,
    root: FileNodePath,
...
pub fn insert_changed_path_status(
