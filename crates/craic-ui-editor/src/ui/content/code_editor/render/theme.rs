...
pub struct EditorTheme {
    ...
    pub line_number_emphasis: Color,
    pub folded_text: Color,
    pub selection: Color,
    ...
    pub deleted_gutter_background: Color,
    pub deleted_hint: Color,
...
pub fn lerp_color(start: Color, end: Color, amount: f64) -> Color {
    Color {
