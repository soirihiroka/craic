...
pub fn invalidate_layout(state: &Rc<EditorState>) {
    state.layout_cache.borrow_mut().take();
    state.layout_dirty.set(true);
}

pub fn invalidate_highlights(state: &Rc<EditorState>) {
...
pub fn max_scroll_y(state: &Rc<EditorState>, viewport_height: f64) -> f64 {
...
pub fn viewport_width(width: i32) -> i32 {
...
pub fn line_height(state: &Rc<EditorState>) -> f64 {
