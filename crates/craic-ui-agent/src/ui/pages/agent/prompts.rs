...
const PROMPT_BUTTON_SIDE_MARGIN: i32 = 6;
...
impl PromptBar {
    ...
    pub fn set_local_repo_path(&self, repo_path: Option<&Path>) {
    ...
    pub fn connect_prompt_selected<F>(&self, callback: F)
    where
...
fn add_prompt_button(
    ...
    let label_width_chars = prompt_file.label.chars().count() as i32;
